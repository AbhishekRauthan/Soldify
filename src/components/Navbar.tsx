...
const Links = () => {
  return (
    <>
      <div className="mx-3 my-3 transform hover:-translate-y-1 duration-300 ease-in-out md:relative">
...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 bg-white shadow-xl py-4 z-10">
      <div className="container relative mx-auto px-4  md:px-5 lg:px-0 flex justify-between items-center ">
        <div className="bg-purple-500 skew-y-3">
          <h1 className="font-lexio text-2xl md:text-3xl uppercase -skew-y-3 font-bold ">
            Soldify
          </h1>
        </div>
        <nav
