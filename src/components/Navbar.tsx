    ...
    <header className="bg-white w-full px-5 xl:px-0 sticky top-0 shadow-md lg:shadow-xl py-4 z-20">
      <nav className="py-1 container relative flex justify-between items-center">
        <div className="skew-y-3 bg-gradient-to-r from-pink-500  to-purple-500">
          <h1 className="font-lexio text-2xl text-black capitalize -skew-y-3 p-1.5">
        ...
        <ul
          className={`${
            closed ? "hidden" : ""
          } absolute md:relative md:inline-flex text-right bg-white shadow-xl top-12 -right-3 md:top-0 md:right-0 space-y-3 md:space-y-0 md:space-x-10 p-3 md:p-0 md:flex-grow justify-end md:shadow-none md:bg-transparent`}
        >
          <Links />
        </ul>
      </nav>
